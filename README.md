...
`minikube mount /"path to files":mount-9p`  - `ex: minikube mount /Users/path/to/files/:mount-9p`  - leave the tab used to mount open. Move back to the tab where minikube is running.
